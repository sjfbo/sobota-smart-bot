...
![visual demo](demo.gif "Sobota Slack Demo")

This bot has been created using [Bot Framework](https://dev.botframework.com), it shows how to:
- Use [LUIS](https://www.luis.ai) to implement core AI capabilities.
- Sobota understands (within some limits) a user request (in English) to get the current weather in a 
city via the OpenWeatherMap API.

Note:
- Some cities' names might not be recognized by LUIS, the default trained model that I improved a bit
is still not so good for some less known cities.
